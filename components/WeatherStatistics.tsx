...
const WeatherStatistics = ({ isMain }) => {
    ...
    return (
        <Wrapper>
            ...
            <Progress type="circle" width={60} percent={statistic.sun} format={() => Icon.sun} />
            {statistic.sun}%
            <Progress type="circle" width={60} percent={statistic.cloud} format={() => Icon.cloud} />
            {statistic.cloud}%
            <Progress type="circle" width={60} percent={statistic.rain} format={() => Icon.rain} />
            {statistic.rain}%
            <Progress type="circle" width={60} percent={statistic.moon} format={() => Icon.moon} />
            {statistic.moon}%
        </Wrapper>
    );
};
