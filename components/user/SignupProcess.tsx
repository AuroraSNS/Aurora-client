...
import { signupRequestAction } from '../../actions/user.ts';
...
const SignupProcess = () => {
    ...
    return (
        <>
            {signupRequest ? (
                <SuccessMessage>
                    이메일 인증을 위한 메일이 전송되었습니다!
                    <br />
                    전송된 이메일을 통해 인증을 마무리해주세요 :)
                </SuccessMessage>
            ) : (
                <>
                    <Link href="signin">
                        <MoveToSigninPage>이미 회원이신가요?</MoveToSigninPage>
                    </Link>
                    <InputContainer>
                        ...
                        <form onSubmit={handleSignup}>
                            ...
                            <EmptyBox>
                                ...
                                {signupErrorMsg ? <ErrorMessage>{signupErrorMsg}</ErrorMessage> : ''}
                            </EmptyBox>
