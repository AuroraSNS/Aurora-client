                ...
                <li>
                    <Link href="/chat">
                        <Tap name="Chat" selected={page}>
                            ...
                            메시지
                            {allNotification?.chatting && <span>{allNotification.chatting}</span>}
                        </Tap>
                    </Link>
                </li>
                <li>
                    <Link href="/notification">
                        <Tap name="Notification" selected={page}>
                            ...
                            알림
                            {allNotification?.notification && <span>{allNotification.notification}</span>}
                        </Tap>
                    </Link>
                </li>
                <li>
                    <Link href="#">
                        <Tap name="Friend" selected={page}>
                            ...
                            친구
                            {allNotification?.friend && <span>{allNotification.friend}</span>}
                        </Tap>
                    </Link>
                </li>
            </ul>
