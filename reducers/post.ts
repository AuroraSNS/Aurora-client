...
import {
    ...
    CHANGE_TIME,
    FILTER_WEATHER,
    FIRST_LOAD_ALL_POST_FAILURE,
    FIRST_LOAD_ALL_POST_REQUEST,
    FIRST_LOAD_ALL_POST_SUCCESS,
    FIRST_LOAD_POST_FAILURE,
    FIRST_LOAD_POST_REQUEST,
    FIRST_LOAD_POST_SUCCESS,
    LIKE_POST_FAILURE,
    LIKE_POST_REQUEST,
    LIKE_POST_SUCCESS,
    ...
    LOAD_LIKE_POST_FAILURE,
    LOAD_LIKE_POST_REQUEST,
    LOAD_LIKE_POST_SUCCESS,
    LOAD_STATISTICS_FAILURE,
    LOAD_STATISTICS_REQUEST,
    LOAD_STATISTICS_SUCCESS,
    MORE_LOAD_ALL_POST_FAILURE,
    MORE_LOAD_ALL_POST_REQUEST,
    MORE_LOAD_ALL_POST_SUCCESS,
    MORE_LOAD_POST_FAILURE,
    MORE_LOAD_POST_REQUEST,
    MORE_LOAD_POST_SUCCESS,
